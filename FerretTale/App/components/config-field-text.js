...
<label class="config-field config-field-text">
    <span></span>
    ...
    setValue(inValue, inIsUserChange) {
        ...
        this.eInput.value = this.displayFormatter != null ? this.displayFormatter(this.getValidatedValue()) : this.getValidatedValue();
